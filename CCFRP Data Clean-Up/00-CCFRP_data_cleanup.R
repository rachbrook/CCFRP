...
# read in trip data
trips <- read.csv("CSV_Files/1-Trip Information.csv")
# read in drift data
drifts_all <-read.csv("CSV_Files/3-Drift Information.csv")
# read in catch data
catches <- read.csv("CSV_Files/4-Caught Fishes.csv")
#Species lookup
Species <- read.csv("CSV_Files/Fish Species.csv")
...
Areas <- read.csv("CSV_Files/Monitoring Areas.csv")
...
#Also remove all cells with MM and RR - drifted outside either the reference area or MPA cells
